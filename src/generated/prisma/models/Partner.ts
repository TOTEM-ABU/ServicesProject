...
export type PartnerModel =
  runtime.Types.Result.DefaultSelection<Prisma.$PartnerPayload>;
...
> = {
  where?: Prisma.PartnerWhereInput;
  orderBy?:
    | Prisma.PartnerOrderByWithAggregationInput
    | Prisma.PartnerOrderByWithAggregationInput[];
...
type GetPartnerGroupByPayload<T extends PartnerGroupByArgs> =
...
export type PartnerGetPayload<
  S extends boolean | null | undefined | PartnerDefaultArgs,
...
> {
  [K: symbol]: {
    types: Prisma.TypeMap<ExtArgs>['model']['Partner'];
    meta: { name: 'Partner' };
  };
  /**
  ...
  >(
    args: Prisma.SubsetIntersection<T, PartnerGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetPartnerGroupByPayload<T>
...
> = {
  ...
  data: Prisma.XOR<
    ...
    Prisma.PartnerUncheckedUpdateInput
  >;
  /**
